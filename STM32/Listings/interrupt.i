...
void Int_Config(INT_Config_t *INT){
	...
	y = INT->Line;
		...
		((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[(y/4)]	|= (x << 4*y);
...
void Int_EdgeSel(INT_Config_t *INT){
	...
	if (INT->Edge == 1){
		...
		((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR |= (1 << INT->Line);
		
	}
	
	if (INT->Edge == 0)
	{
		((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR |= (1 << INT->Line);
	}
...
void Int_Enable(INT_Config_t *INT){
	...
	((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR |= (1 << INT->Line);
	
}

void Int_EventEn(INT_Config_t *INT){
	
	((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR |= (1 << INT->Line);
	
}

void Int_SWInt(INT_Config_t *INT){
	
	((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->SWIER |= (1 << INT->Line);
	
}

void Int_ClearPend(INT_Config_t *INT){
	
	((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->PR |= (1 << INT->Line);
